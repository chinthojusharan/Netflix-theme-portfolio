    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-zinc-900 to-black text-white px-6 py-10 pt-20">
              ...
              <div className="backdrop-blur bg-white/5 border border-zinc-800 p-4 rounded-xl shadow-lg hover:scale-[1.03] hover:shadow-[0_0_20px_4px_rgba(239,68,68,0.5)] transition-all duration-300">
                ...
                <div className="flex flex-wrap gap-2 text-xs text-zinc-300 mb-4">
                  {project.techStack.split(',').map((tech, i) => (
                    <span key={i} className="bg-red-600/20 px-2 py-1 rounded-full">{tech.trim()}</span>
                  ))}
                </div>
      ...
      <section className="mb-20">
        ...
        <p className="text-zinc-300 leading-relaxed max-w-4xl">
          Hey, I'm <span className="text-red-500 font-medium">Sharan</span> — a full-stack web developer obsessed with
          creating cool, cinematic UIs like this one. I enjoy turning ideas into interactive websites using the MERN
          stack. My goal? Build apps that people love to use.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-zinc-300 mb-2">
          📧 <span className="text-white">chinthojusharan@gmail.com</span>
        </p>
        <p className="text-zinc-300">
          🔗{' '}
          <a
            href="https://www.linkedin.com/in/sharan-cchinthoju-16067331b"
            target="_blank"
